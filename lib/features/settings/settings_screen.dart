              ...
              try {
                ...
                if (mounted) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(
                        'Delete failed: $e. Try logging out and back in first.',
                      ),
                  ...
                  children: [
                      ...
                      child: Column(
                        children: [
                          ListTile(
                            ...
                            subtitle: const Text(
                              'Change photo, work details, contact info',
                            ),
                            trailing: const Icon(
                              Icons.arrow_forward_ios_rounded,
                              color: AppColors.textMuted,
                          ...
                          SwitchListTile(
                            ...
                            onChanged: (val) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text(
                                    '🎨 Vibrant Dark Mode is optimized for premium glassmorphic UI.',
                                  ),
                                  backgroundColor: AppColors.primary,
                          ...
                          SwitchListTile(
                            ...
                            subtitle: const Text(
                              'Receive push alerts on summary completion',
                            ),
                          ...
                          ListTile(
                            ...
                            subtitle: const Text(
                              'Manage database security and policy details',
                            ),
                            trailing: const Icon(
                              Icons.arrow_forward_ios_rounded,
                              color: AppColors.textMuted,
                          ...
                          ListTile(
                            ...
                            subtitle: const Text(
                              'Permanently remove meetings and profile data',
                            ),
                            trailing: const Icon(
                              Icons.arrow_forward_ios_rounded,
                              color: AppColors.error,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (settings.deepgramKeyFromEnv)
                            ...
                            TextFormField(
                              initialValue: settings.deepgramKey.isEmpty
                                  ? null
                                  : '••••••••••••••••',
                              readOnly: true,
                              enabled: false,
                    ...
                    GlassCard(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8),
                          (() {
                            final ollamaState = ref.watch(
                              ollamaConnectionManagerProvider,
                            );
                            ...
                            return Column(
                              ...
                              children: [
                                ...
                                if (ollamaState.status ==
                                        OllamaConnectionStatus.connected &&
                                    ollamaState.activeModel != null) ...[
                                  const SizedBox(height: 4),
                                  Padding(
                                    padding: const EdgeInsets.only(left: 24.0),
                                    child: Text(
                                ...
                                if (ollamaState.errorMessage != null &&
                                    ollamaState.status !=
                                        OllamaConnectionStatus.connected) ...[
                                  const SizedBox(height: 6),
                                  Padding(
                    ...
                    GlassCard(
                      child: Column(
                        ...
                        children: [
                          const Text(
                            'Speech & Emotion Analytics Backend URL',
                            style: TextStyle(
                              fontSize: 13,
                              fontWeight: FontWeight.bold,
                              color: AppColors.textSecondary,
                          ...
                          const SizedBox(height: 8),
                          TextFormField(
                            initialValue: settings.customBackendUrl,
                            decoration: const InputDecoration(
                            ...
                            onChanged: (val) {
                              ref
                                  .read(settingsProvider.notifier)
                                  .saveCustomBackendUrl(val.trim());
                            },
                          ),
                          const SizedBox(height: 16),
                          (() {
                            final healthState = ref.watch(
                              emotionHealthServiceProvider,
                            );
                            final isOnline = healthState.isOnline;

                            Color statusColor = AppColors.error;
                            String statusTitle = 'Offline';
                            if (isOnline) {
                              statusColor = AppColors.success;
                              statusTitle = 'Connected';
                            } else if (healthState.isConnecting ||
                            ...
                            return Column(
                              ...
                              children: [
                                ...
                                if (healthState.activeUrl.isNotEmpty) ...[
                                  const SizedBox(height: 4),
                                  Padding(
                                    padding: const EdgeInsets.only(left: 18.0),
                                    child: Text(
                                      'URL: ${healthState.activeUrl}',
                                      style: const TextStyle(
                                        fontSize: 12,
                                        color: AppColors.textSecondary,
                                      ),
                      ...
                      child: Column(
                        children: [
                          SwitchListTile(
                            ...
                            subtitle: const Text(
                              'Continue recording when screen is locked',
                            ),
